...
<head>
    ...
    <title>Products Inventory - Bookivia</title>
                                          ...
                                          <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white u-s-m-b-30">
                                              <div class="dash__pad-2">
                                                  <div class="dash__address-header">
                                                      <h1 class="dash__h1">Product inventory</h1>
                                                      <div>

                                                        <a class="dash__custom-link btn--e-brand-b-2" href="dashboard-product-add.php"><i class="fas fa-plus u-s-m-r-8"></i>
                                              ...
                                              <div class="dash__table-2-wrap gl-scroll">
                                                  <table class="dash__table-2">
                                                      ...
                                                      <tbody>
                                                        ...
                                                        <tr>
                                                            <td>
                                                              <a class="address-book-edit btn--e-transparent-platinum-b-2" href="dashboard-product-edit.php?id=<?php echo $r['Book_ISBN']; ?>">Edit</a>
                                                            <a class="address-book-edit btn--e-transparent-platinum-b-2" href="delproduct.php?id=<?php echo $r['Book_ISBN']; ?>">Remove</a></td>
                                                            <td><?php echo $r['Book_ISBN']; ?></td>
                                                            <td><?php echo $r['Book_Title']; ?></td>
                                                            <td><?php echo $r['Book_Author']; ?></td>
                                                            <td><?php echo $r['Book_Edition']; ?></td>
                                                            <td><?php echo $r['Book_Published_Date']; ?></td>
                                                            <td><?php echo $r['Book_Genre']; ?></td>
                                                            <td><?php echo $r['Book_Format']; ?></td>
                                                            <td><?php echo $r['Book_Editorial']; ?></td>
                                                            <td><?php echo $r['Book_Status']; ?></td>
                                                            <td><?php echo $r['Book_Price']; ?></td>
                                                            <td><?php echo $r['Book_Cost']; ?></td>
                                                            <td><?php if($r['Book_Image']){echo "Yes.";}else{echo "No.";} ?></td>
                                                            <td><?php echo $r['Book_Quantity']; ?></td>
                                                        </tr>
                                                      <?php } ?>
                                                      </tbody>
                                                  </table>
