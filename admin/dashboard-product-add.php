<?php
  ...
  if(isset($_FILES) & !empty($_FILES)){
  	...
  	echo "Please select a file";
  	  ...
  	  $sql = "INSERT INTO bookivia_books (Book_ISBN, Book_Title, Book_Author, Book_Edition,
      	Book_Published_Date, Book_Genre, Book_Format, Book_Editorial, Book_Status, Book_Price, Book_Cost, Book_Image, Book_Quantity)
      	VALUES ('$ISBN', '$Title', '$Author', '$Edition', '$Published_Date', '$Genre', '$Format', '$Editorial', '$Status', '$Price', '$Cost', '$location$name', '$Quantity')";
  	$res = mysqli_query($db, $sql);
  	if($res){
  	$smg = "Product Added successfully.";
  	}else{
  	$smg = "Unable to add product.";
  	}
  }
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Add Products - Bookivia</title>
                                ...
                                <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white">
                                    <div class="dash__pad-2">
                                      <div class="dash__box dash__box--shadow dash__box--radius dash__box--bg-white">
                                        ...
                                        <span class="dash__text u-s-m-b-30">Add product specifications.</span>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                              <div class="u-s-m-b-30">
                                                  ...
                                                  <input class="input-text input-text--primary-style" type="text" id="book_ISBN" name="book_ISBN"></div>
                                                    <div class="gl-inline">
                                                        <div class="u-s-m-b-30">

                                                            <label class="gl-label" for="reg-fname">PRODUCT NAME (BOOK TITLE) *</label>

                                                            <input class="input-text input-text--primary-style" type="text" id="book_Title" name="book_Title"></div>
                                                        <div class="u-s-m-b-30">

                                                            <label class="gl-label" for="reg-lname">AUTHOR *</label>

                                                            <input class="input-text input-text--primary-style" type="text" id="book_Author" name="book_Author"></div>
                                                    </div>
                                                    <div class="gl-inline">
                                                        <div class="u-s-m-b-30">
                                                            ...
                                                            <input class="input-text input-text--primary-style" type="text" id="book_Edition" name="book_Edition"></div>
                                                        <div class="u-s-m-b-30">

                                                            <label class="gl-label" for="reg-fname">PUBLISHED DATE (YYYY/MM/DD) *</label>

                                                            <input class="input-text input-text--primary-style" type="text" id="book_Published_Date" name="book_Published_Date"></div>
                                                    </div>
                                                    <div class="gl-inline">
                                                      <div class="u-s-m-b-12">
                                                          <label class="gl-label" for="style">GENRE *</label><select class="select-box select-box--primary-style u-w-100" id="book_Genre" name="book_Genre">
                                                    ...
                                                    <div class="gl-inline">
                                                        ...
                                                        <div class="u-s-m-b-30">
                                                            ...
                                                            <div class="u-s-m-b-30">
                                                                ...
                                                                <input class="input-text input-text--primary-style" type="text" id="book_Editorial" name="book_Editorial"></div>
                                                    </div>
                                                    <div class="gl-inline">
                                                      <div class="u-s-m-b-30">

                                                          <label class="gl-label" for="style">Status *</label><select class="select-box select-box--primary-style u-w-100" id="book_Format" name="book_Status">
                                                              <option selected>Select</option>
                                                        ...
                                                        <div class="u-s-m-b-30">
                                                            ...
                                                            <input class="input-text input-text--primary-style" type="text" id="book_Cost" name="book_Cost"></div>
                                                    </div>
                                                  <div class="gl-inline">
                                                    ...
                                                    <div class="table-p__input-counter-wrap">
                                                        ...
                                                        <div class="input-counter">
                                                            ...
                                                            <input class="input-counter__text input-counter--text-primary-style" type="text" value="1" data-min="1" name="book_Quantity" data-max="1000">
                                                    ...
                                                    <div class="u-s-m-b-30">
                                                        ...
                                                        <input class="input-text input-text--primary-style" type="text" id="book_Price" name="book_Price"></div>
                                                  </div>
