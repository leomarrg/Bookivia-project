(function ($) {
  ...
  $(function () {
    ...
    if ($("#mixed-chart").length) {
      var chartData = {
        labels: ['Day/month/weekly/month', 'Day/month/weekly/month', 'Day/month/weekly/month', 'Day/month/weekly/month', 'Day/month/weekly/month', 'Day/month/weekly/month', 'Day/month/weekly/month'],
        datasets: [{
          type: 'line',
          label: 'Revenue',
      ...
      lineChart = new Chart(MixedChartCanvas, {
        ...
        options: {
          ...
          title: {
            display: true,
            text: 'Sales, Returns and Revenue'
          },
          scales: {
            xAxes: [{
              display: true,
    ...
    if ($("#salesGroupedProduct").length) {
      var pieChartCanvas = $("#salesGroupedProduct").get(0).getContext("2d");
