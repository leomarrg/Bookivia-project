...
if(isset($_POST) & !empty($_POST)){
	...
	if($count == 1){
      ...
      if($ures){
      "Insert orders into orders table & order item table - ures";
      }
	   }else{
	...
	bAddress2, bCountry, bState, bCity, bZip_Code) VALUES ('$cusID', '$phone', '$mAddress1', '$mAddress2', '$mCountry', '$mState', '$mCity',
     ...
     if($ires){
       "Insert orders into orders table & order item table - ires";
     }
	}
}
$sql = "SELECT * FROM bookivia_address WHERE cAccount_ID = $cusID";
                                      ...
                                      <div class="dash__pad-1">
                                          ...
                                          <ul class="dash__f-list">
                                              ...
                                              <li>
                                                  ...
                                                  <a class="dash-active" href="dash-address.php">Address</a></li>
                                              <li>
